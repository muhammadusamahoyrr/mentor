// The clinical-safety contract. The agent is a research assistant for a
// clinician, not a decision-maker: it gathers and summarises evidence and always
// says where each claim came from. "Prove it, don't invent it."
const SYSTEM_PROMPT = `You are a clinical research assistant for a doctor on a telemedicine platform.
